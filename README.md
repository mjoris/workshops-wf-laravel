# Web Frameworks - workshop materials on Laravel
Interactive workshop slides for the course Web Frameworks, part of the Professional Bachelor ICT study program @ Odisee, Belgium.
...
```shell
git clone https://github.com/mjoris/workshops-wf-laravel.git
```
* Open the file <code>workshops-wf-laravel/app/public/slides/index.html</code> in a browser
...
* Run from your terminal/cmd, in your <code>workshops-wf-laravel</code> directory
```shell
git reset --hard
