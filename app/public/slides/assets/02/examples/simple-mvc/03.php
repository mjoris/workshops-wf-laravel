<pre><?php
    ...
    class Model
    {
        ...
        public function __get(string $key) // magic method for inaccessible properties '->'
        {
            return $this->assocArray[$key];
        }

        public function __set(string $key, string $value) // magic method for inaccessible properties '->'
        {
