...
<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header"><!-- Just an image -->
            ...
            <a class="navbar-brand" href="{{ route('products.overview')  }}">{{ $title }}</a>
        </div>
        @auth
...
<footer class="footer mt-auto py-3">
    <div class="container">
        <span class="text-muted">&copy; {{ now()->year }} Odisee &mdash; Opleiding Elektronica-ICT &mdash; Full-stack Advanced</span>
    </div>
</footer>
